...
parser.add_argument('-c', type=str, help='channels (R/G/B/A) or any combination, comma separated, valid values: r,g,'
                                         'b,a,rg,bgr,rgba,r3g2b3,...')
...
parser.add_argument('-s', '--strings', choices=["first, all, longest, none"], help='extract specified payload, NAME '
                                                                                   'is like \'1b,rgb,lsb\'')
